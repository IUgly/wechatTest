...
function getApi(key){
    var apis = {};
    apis['POST-POINT'] = 'http://kuangjunlin.natapp1.cc/over';//每死一次就保存分数数据地址
    apis['GET-RANK'] = 'http://kuangjunlin.natapp1.cc/rank';//获得排行榜数据和个人排名
    apis['USER-INFO'] = 'http://kuangjunlin.natapp1.cc/game';//每次开始游戏获取用户数据
    apis['SHARE'] = '';//这个不填
